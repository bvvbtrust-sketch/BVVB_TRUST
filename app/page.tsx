...
<div className="footer-col">
  ...
  <div className="social-icons" style={{ display: 'flex', gap: '15px' }}>
    {[
      { 
        label: 'FB', 
        url: 'https://www.facebook.com/bvvb_trust',
      ...
      <a 
        ...
        onMouseOver={(e) => {
          e.currentTarget.style.background = '#f1c40f'; // హోవర్ చేసినప్పుడు గోల్డ్ కలర్
          e.currentTarget.style.transform = 'translateY(-3px)';
          const svg = e.currentTarget.querySelector('svg');
          if (svg) svg.style.fill = '#2c1e14'; // హోవర్ చేసినప్పుడు ఐకాన్ డార్క్ కలర్
        }}
        onMouseOut={(e) => {
